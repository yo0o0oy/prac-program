...
- [Typescript](#typescript)
  ...
  - [学習内容まとめ](#学習内容まとめ)
    - [基本の型推論とアノテーション](#基本の型推論とアノテーション)
    - [関数](#関数)
    - [オブジェクト](#オブジェクト)
    - [配列/タプル](#配列タプル)
    - [ジェネリック型（総称型）](#ジェネリック型総称型)
    - [クラス](#クラス)
    - [Interfaceと型エイリアスの違い](#interfaceと型エイリアスの違い)
    - [非同期処理](#非同期処理)
...
## <h2 id="typescriptの特徴">Typescriptの特徴</h2>
 * 型推論付きの静的型付け言語
...
## <h2 id="学習内容まとめ">学習内容まとめ</h2>

### <h3 id="基本の型推論とアノテーション">基本の型推論とアノテーション</h3>
...
### <h3 id="ジェネリック型（総称型）">ジェネリック型（総称型）</h3>
...
### <h3 id="interfaceと型エイリアスの違い">Interfaceと型エイリアスの違い</h3>
 * Interface
   - interface宣言子で定義
   - 型エイリアスと違って `=` は不要
